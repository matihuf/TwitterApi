namespace QuickType.UserSearchResponse
{
    using System;
    ...
    public partial class UserSearchResponse
    {
        ...
        public UserSearchResponseEntities Entities { get; set; }
    ...
    public partial class UserSearchResponseEntities
    {
        [JsonProperty("url")]
    ...
    public partial class UserSearchResponse
    {
        public static UserSearchResponse[] FromJson(string json) => JsonConvert.DeserializeObject<UserSearchResponse[]>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this UserSearchResponse[] self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
